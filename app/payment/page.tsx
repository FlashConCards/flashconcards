        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="font-medium">R$ 399,90</span>
            </div>
            <div className="flex justify-between items-center">
          ...
          <div className="border-t pt-4">
            ...
            <div className="flex justify-between items-center mt-2">
              ...
              <span className="text-2xl font-bold text-green-600">R$ 129,99</span>
            </div>
                  ...
                  <div>
                   ...
                   <div>
                     ...
                     >
                       ...
                       <option value="2">2x de R$ 64,99 sem juros</option>
                       <option value="3">3x de R$ 43,33 sem juros</option>
                       <option value="6">6x de R$ 21,66 sem juros</option>
                       <option value="12">12x de R$ 10,83 sem juros</option>
                     </select>
                   </div>
                   ...
                   >
                     {isLoading ? (
                       ...
                       `Pagar ${installments === '1' ? 'R$ 129,99' : 
                                installments === '2' ? '2x de R$ 64,99' :
                                installments === '3' ? '3x de R$ 43,33' :
                                installments === '6' ? '6x de R$ 21,66' :
                                '12x de R$ 10,83'}`
                     )}
                   </button>
                </form>
